 ...
 * Also used for Grok (OpenAI-compatible).
 */
export const OPENAI_SYSTEM_PROMPT = `# AI Screenwriting Assistant
...
Some user messages may contain important information about the project (confirmed character traits, world rules, story decisions, canonical events, naming conventions, project structure).

When such information appears, you may propose updates for the project's memory. The application will decide whether to apply them to memory.md.

/**
 * Yandex GPT system prompt.
 * Includes Yandex-specific notes about model selection and capabilities.
 */
export const YANDEX_SYSTEM_PROMPT = `# AI Screenwriting Assistant — YandexGPT
